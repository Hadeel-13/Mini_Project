            ...
            <Link to={`/movie/${props.id}`}>
                <div className="group relative shadow hover:shadow-xl rounded-2xl overflow-hidden transition-all duration-500 hover:-translate-y-2 ">
                    <div className="">
                        ...
                        />
                        <div className="p-5 absolute text-white w-full bottom-0 rounded-t-lg bg-gradient-to-t from-slate-900 to-slate-600 opacity-80 group-hover:opacity-60 group-hover:translate-y-16 duration-500 transition-all">
